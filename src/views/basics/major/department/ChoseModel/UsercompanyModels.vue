...
export default {
  ...
  methods: {
    ...
    handleGetCompany () {
      this.$request.post('/financeback/company/findCompanyPage', this.params).then(res => {
...
<style lang="less">
  ...
  /*  padding-left: 10px;*/
  /*}*/
  .company-select-modals .ivu-modal-no-mask{
    z-index: 1001;
  }
  .company-select-modals {
