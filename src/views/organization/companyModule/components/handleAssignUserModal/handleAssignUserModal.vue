<template>
  <div class="handleAssignUserModal">
    <Modal
    v-model= "handleAssignUserModal"
    :transfer="false"
    :closable="false"
    :mask-closable="false"
    draggable
    ...
    >
      <header
        ...
        slot="header"
      >
        <div class="modal-header-name page-header-name">分配用户</div>
...
export default {
  ...
  methods: {
    ...
    doGetInit () {
      ...
      this.$request.post('/financeback/sysUser/findPage', req).then(res => {
...
@import 'handleAssignUserModal.less';
</style>
