...
<Modal
  ...
  <section class="page-content">
    ...
    <div class="page-content-table">
      <Table :columns="tableColumns" :data="tableData" :no-data-text="null" :height="tableData.length ? '350' : ''"></Table>
  ...
  <div slot="footer">
    <section class="page-footer" v-if="tableData.length!==0">
      ...
      <div class="page-footer-rt">
        ...
        <Button size="small" @click="goElevatorPage('pageBank')">GO</Button>
      </div>
    </section>
  </div>
</Modal>
...
export default {
      ...
      tableColumns: [
        ...
        },
        {
          ...
          render: (h, { row, index, column }) => {
            return (
              <div>
                <span class="table-span" onClick= {this.$emit.bind(this, 'getBankName', { row })}>选择</span>
              </div>
            )
          }
        }
  ...
  computed: {
    bankShow: {
      get () {
        return this.bankModal.isShow
      },
      set (data) {
        this.$emit('getShowBank', false)
        return data
      }
    }
  },
  methods: {
    ...
    doInit () {
      ...
      this.$request.post('/financeback/bankAccount/findBankPage', reqDate).then(result => {
